...
**Phase C backlog (SMTP / supplier returns / shop card pay / accountant rule): do not schedule until agreed with client** — dated note **2026-05-04** · see **`docs/SESSION_2026-05-04_HANDOFF.md`** §2.
